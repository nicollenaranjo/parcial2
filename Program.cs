...
namespace linq
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           /* String output = JsonConvert.SerializeObject(Francia);
            File.WriteAllText("./seleccionFrancia.json", output);
            Seleccion FranciaDeserializada = JsonConvert.DeserializeObject<Seleccion>(output);//(File.ReadAllText("./seleccionFrancia.json"));
            String jugadoresFranciaSerializados = JsonConvert.SerializeObject(Francia.Jugadores);
            ...
            Jugador j1 = new Jugador("Cristiano", 35, 7, 98, 40, 25, 3);
            string jugadorSeri = JsonConvert.SerializeObject(j1);
            File.WriteAllText("./jugadores.json", jugadorSeri);*/
           ...
           /* Partido partido1 = new Partido(Francia, Argentina);
            ...
            {
                JsonSerializer serializer = new JsonSerializer();
                Jugador jugador3  = (Jugador)serializer.Deserialize(file, typeof(Jugador));
